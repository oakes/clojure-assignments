...
Create a new console project. In Clojure, it's normal to represent most things with plain data structures. In the case of, for example, a 10 of hearts, we could represent it as a hash map: `{:rank 10, :suit :hearts}`. Let's click "Run with REPL" and open `core.clj`.
